...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\store\datasets.js
//#######################################################################
...
export const useDatasetStore = defineStore('datasets', () => {
    ...
    async function fetchDatasets() {
        ...
        error.value = null;
        try {
            // [AWENK] Axios response strukturnya response.data
            // Backend biasanya return { status: 'success', data: [...] } atau langsung array
            const response = await api.get('/api/v1/datasets');

            // Handle variasi output backend
