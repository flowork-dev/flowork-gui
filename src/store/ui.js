...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\store\ui.js total lines 226 
//#######################################################################
...
export const useUiStore = defineStore('ui', () => {
  ...
  const isFooterPinned = ref(savedPinState === 'true'); // Default ambil dari cache browser
  ...
  function loadUiPreferences(settingsData) {
      if (settingsData && settingsData.ui_footer_pinned !== undefined) {
          ...
          console.log(`[UI Store] Footer pin state synced from server: ${isFooterPinned.value}`);
      }
  }
