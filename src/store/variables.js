...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\store\variables.js total lines 115 
//#######################################################################
...
export const useVariablesStore = defineStore('variables', () => {
    ...
    async function fetchVariables() {
        ...
        try {
            ...
            aiProviders.value = []; // Typo fix dari konteks sebelumnya, aman dihapus kalau gak perlu
        } finally {
