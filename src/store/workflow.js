...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\store\workflow.js total lines 1305 
//#######################################################################
...
export const useWorkflowStore = defineStore('workflow', () => {
    ...
    function updateNodeExecutionStatus(metric) {
        if (!metric?.node_id) return; // Allow updates even without matching jobId for flexibility
    ...
    return {
        ...
        isLoadingPresets,
        handleFetchError,
        animateIncomingEdges // (English Hardcode) Exported new helper
    };
});
