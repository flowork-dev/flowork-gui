...
import { useEngineStore } from './engines'; // PENTING: Ambil Engine Store
...
export const usePromptStore = defineStore('prompts', () => {
    ...
    function getApiConfig() {
        ...
        const activeEngineId = engineStore.activeEngine?.id || engineStore.engines[0]?.id; // Fallback ke engine pertama kalau null
    ...
    async function savePrompt(promptData) {
        ...
        const config = getApiConfig(); // Get Headers
