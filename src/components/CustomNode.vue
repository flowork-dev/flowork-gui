...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\components\CustomNode.vue total lines 371
//#######################################################################
...
const nodeClass = computed(() => {
  ...
  if (componentType.value === 'triggers') {
    ...
    // [FIX] Tambahkan class khusus buat Prompt Receiver biar beda dari Action biasa
