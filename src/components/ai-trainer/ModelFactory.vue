...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\components\ai-trainer\ModelFactory.vue total lines 426 
//#######################################################################
            ...
            <div>
                ...
                <div class="d-flex align-center gap-2 mb-2">
                    ...
                    <v-btn
                        ...
                        @click="trainingStore.rescanModels"
                ...
                <div class="text-caption text-grey-darken-1 mb-6 font-mono" v-if="!conversionConfig.model_id">
                    ...
                    <span v-if="convertibleModels.length === 0">No adapters found? Try hitting refresh.</span>
