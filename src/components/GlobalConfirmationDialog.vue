...
# File NAME : C:\FLOWORK\flowork-gui\template\web\src\components\GlobalConfirmationDialog.vue
# CATATAN: File BARU. Komponen dialog global untuk menggantikan confirm().
#######################################################################
<template>
  <v-dialog
