...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\components\LanderHeader.vue total lines 238 
//#######################################################################
...
/* (English Hardcode) START ADDED CODE - FASE 13 (Rule #2) */
.header-btn.orbitron-font {
    font-family: 'Orbitron', monospace;
    color: var(--text-secondary) !important; /* (English Hardcode) Rule #5: High contrast text */
}
