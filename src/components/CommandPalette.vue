...
// --- Daftar Perintah (Ini bisa diperluas) ---
const allCommands = computed(() => [
  ...
  { id: 'wf_save', title: 'Save Workflow', icon: 'mdi-content-save', color: 'cyan', action: () => document.dispatchEvent(new CustomEvent('flowork-save-request')) }, // Trik untuk memanggil save dari footer
...
// Reset search saat dialog ditutup/dibuka
