...
// (English Hardcode) Auth/Socket logic MOVED TO main.js for robustness.

import { onMounted, onUnmounted, computed, watch } from 'vue';
import { useRoute } from 'vue-router';
import { useAuthStore } from '@/store/auth';
import { useUiStore } from '@/store/ui';
// (English Hardcode) socketStore import is not needed here anymore, main.js handles it.
...
// const socketStore = useSocketStore(); // (English Hardcode) Not needed, main.js handles connection logic.
...
onMounted(async () => {
  ...
  // (English Hardcode) MOVED TO main.js: This logic is now centralized.
  ...
  if (authStore.isAuthenticated) {
    if (!socketStore.isConnected || !socketStore.isAuthenticated) {
      console.log('App.vue onMounted: Auto-reconnecting socket...');
      socketStore.connect();
    }
  }
  */
...
// (English Hardcode) MOVED TO main.js: This logic is now centralized in main.js using authStore.$subscribe
/*
