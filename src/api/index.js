...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\api\index.js total lines 805
//#######################################################################
...
export const apiSendComponentInput = async (engineId, nodeId, inputData) => {
    try {
        ...
        // Panggil endpoint baru yang udah kita register di component_routes.py
        // URL ini akan di-prefix oleh interceptor menjadi /api/v1/components/run
