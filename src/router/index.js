...
// File NAME : C:\FLOWORK\flowork-gui\template\web\src\router\index.js total lines 219 
//#######################################################################
...
const ModuleFactoryRoute = { path: '/component-forge', name: 'ModuleFactory', component: ModuleFactory, meta: { requiresAuth: true, title: 'Component Forge - Flowork' } };
const ModuleFactoryOld = () => import('@/views/ModuleFactory.vue');
const ModuleFactoryView = () => import('@/views/ModuleFactory.vue');

const ModuleFactoryReal = () => import('@/views/ModuleFactory.vue');

const ModuleFactoryImport = () => import('@/views/ModuleFactory.vue');
...
const WidgetDashboard = () => import('@/views/WidgetDashboard.vue');
...
const routes = [
    ...
    { path: '/component-forge', name: 'ModuleFactory', component: ModuleFactoryImport, meta: { requiresAuth: true, title: 'Component Forge - Flowork' } },
    ...
    },
    {
        ...
        meta: { requiresAuth: true, title: 'Widgets - Flowork' }
    }
];
