...
const navLinks = ref([
    { title: 'AI Trainer', description: 'Fine-tune AI models with your custom data.', icon: 'mdi-school-outline', to: '/ai-trainer' },
    { title: 'Prompt Manager', description: 'Create, manage, and reuse powerful prompt templates.', icon: 'mdi-text-box-multiple-outline', to: '/prompt-manager' },
    { title: 'AI Architect', description: 'Generate entire workflows from a single sentence.', icon: 'mdi-sitemap-outline', to: '/ai-architect' },
    { title: 'Model Factory', description: 'Convert and optimize models to the GGUF format.', icon: 'mdi-factory', to: '/model-factory' },
]);
...
function getProviderIcon(type) {
    if (type === 'local') return 'mdi-server';
