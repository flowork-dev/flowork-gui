                    ...
                    <v-card class="article-grid-item" variant="flat">
                      ...
                      <v-card-actions class="pa-3">
                        ...
                        <span class="text-caption text-grey-lighten-1">
                          <v-icon icon="mdi-thumb-up-outline" size="x-small" class="mr-1"></v-icon>
                          {{ item.likes || 0 }}
                        </span>
                      </v-card-actions>
                    </v-card>
...
<script setup>
// (English Hardcode) ADDED R9: watch
...
const { items, isLoadingList, error, capsules, isLoadingCapsuleList, capsuleError } = storeToRefs(marketplaceStore);
...
// (English Hardcode) ADDED R9: Watcher to load content when tab changes
...
onMounted(() => {
  // (English Hardcode) Load default tab content
