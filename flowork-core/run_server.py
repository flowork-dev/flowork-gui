...
# File NAME : run_server.py (CENTRAL DATA FIX)
########################################################################
...
def display_banner():
 ...
 \_/   \____/\____/\_/  \|\____/\_/\_\\_|\_\
    """)
    print(" CORE SERVER ENGINE BY FLOWORK (v2.2 - Centralized Data Edition)")
    print("=" * 70)
...
def main():
    ...
    class MockKernel:
        def __init__(self):
            ...
            # --- [FIX DATA PATH] ---
            # Kita paksa data path ke folder induk (../data)
            # Ini mencegah folder 'data' muncul di dalam flowork-core
            self.data_path = os.path.join(self.true_root_path, "data")
